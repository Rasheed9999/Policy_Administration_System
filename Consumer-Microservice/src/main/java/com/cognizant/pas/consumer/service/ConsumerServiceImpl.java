...
public class ConsumerServiceImpl implements ConsumerService {
	...
	@Override
	// to create Consumer business models and saving in DB
	...
	// calculate business values using business turnover and capital investment
	@Override
	public Long calBusinessValue(Long businessturnover, Long capitalinvested) {
		...
		Double range_diff = 10.0;
		log.debug("range_diff : {}", range_diff);
		Double sat = ((x_max - x_min) / (x_max + x_min));
	...
	// Update Consumer business models and saving in DB
	@Override
	...
	// return Consumer business models using consumer ID
	@Override
	...
	// create Property business models and saving in DB
	@Override
	...
	// calculate Property values using cost of the asset, salvage value and useful life of the Asset
	@Override
	...
	// update Property business models and saving in DB
	@Override
	...
	// return Consumer business models using consumer ID and property ID
	@Override
	...
	// return boolean value whether business is eligible or not
	@Override
	public Boolean checkBusinessEligibility(ConsumerBusinessRequest consumerBusinessRequest) throws Exception{
		...
		System.out.println(consumerBusinessRequest);
	...
	// return boolean value whether Property is eligible or not
	@Override
