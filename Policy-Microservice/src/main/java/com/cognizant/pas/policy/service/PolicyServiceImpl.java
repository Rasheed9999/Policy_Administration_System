...
public class PolicyServiceImpl implements PolicyService {
	...
	// get quotes from quotes microservice and returns it
	@Override
	...
	// return policy details using consumer ID and policy ID
	@Override
	...
	// create policy and stores it in DB
	@Override
	...
	// get and return consumer details using consuemr id from consumer microservice
	@Override
