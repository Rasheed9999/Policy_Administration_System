...
import com.cognizant.pas.application.utilClasses.DefultValues;

import javax.servlet.http.HttpSession;

@Slf4j
@Controller
// HomeController is responsible to load home page 
// communicating with consumer and policy services
public class HomeController {
	...
	public String displayHomePage(Model model, HttpSession session) {
		model.addAttribute("defultValues", new DefultValues());
